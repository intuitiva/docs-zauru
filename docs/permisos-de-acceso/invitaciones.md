...
Cuando contrata a un nuevo vendedor, cajero o bodeguero, el primer paso para darle acceso a Zauru es enviarle una invitación a su correo. Zauru utiliza el sistema de invitaciones porque necesita asegurarse de que el usuario tenga un correo electrónico válido, para poder comunicarse con él en caso de que olvide la contraseña o de que su cuenta se bloquee por más de 5 intentos fallidos en el ingreso al sistema.
...
Cuando la invitación sea aceptada, el siguiente paso natural es suscribir al usuario y asignarle un rol, para que entre a Zauru con los permisos que le corresponden. Desde esta misma sección puede invitar a todas las personas de su equipo, una invitación por cada correo.
