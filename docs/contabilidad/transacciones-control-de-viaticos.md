...
> Hay empresas que prefieren separar este proceso de las compras de mercadería y es por eso que existe este tutorial.
...
1. Ingresar una transacción por factura de los gastos.
